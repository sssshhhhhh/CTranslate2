...
namespace ctranslate2 {
  ...
  public:
    ...
    float8_t& operator=(float16_t f) {
      ...
      int is_denorm = shifter._bits < exp_threshold;
      if (is_denorm) shifter._bits = exp_threshold;
      ...
      int e8 = ((rounded._bits & 0x7c00) >> 10) - 8;
      uint8_t m8 = (rounded._bits & 0x03ff) >> 7;
